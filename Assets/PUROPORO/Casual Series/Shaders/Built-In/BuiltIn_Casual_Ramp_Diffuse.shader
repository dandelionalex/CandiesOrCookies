...
Shader "PUROPORO/Built-in/BuiltIn_Casual_Ramp_Diffuse"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 temp_cast_0 = (dotResult12).xx;
				
				
				finalColor = ( ase_lightColor * SAMPLE_TEXTURE2D( _RampRGB, sampler_RampRGB, temp_cast_0 ) );
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18400
0;25;1245;915;2353.321;1053.256;3.035029;True;True
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;9;-942.9435,-51.68197;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;8;-913.4006,183.452;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;12;-490.3669,-51.99827;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1;-537.165,-296.4973;Inherit;True;Property;_RampRGB;Ramp (RGB);0;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=751CCAD005BC5E65DE3BA01EA7442A533736A8B2